...
from NibiX import stream_markup
from NibiX.decorators import authorized_users_only
from NibiX.filters import command, other_filters
from NibiX.queues import QUEUE, clear_queue
from NibiX.utils import skip_current_song, skip_item
from NibiMusic import BOT_USERNAME
from NibiMusic import bot as Nirjon
from NibiMusic import call_py
from NibiMusic.config import IMG_3, IMG_5
...
@Nirjon.on_message(command(["reload", f"reload@{BOT_USERNAME}"]) & other_filters)
...
@Nirjon.on_message(command(["skip", f"skip@{BOT_USERNAME}", "vskip"]) & other_filters)
@authorized_users_only
...
@Nirjon.on_message(command(["mute", f"mute@{BOT_USERNAME}", "vmute"]) & other_filters)
@authorized_users_only
...
@Nirjon.on_callback_query(filters.regex("cbpause"))
...
@Nirjon.on_callback_query(filters.regex("cbresume"))
...
@Nirjon.on_callback_query(filters.regex("cbmute"))
...
@Nirjon.on_callback_query(filters.regex("cbunmute"))
...
@Nirjon.on_callback_query(filters.regex("cbskip"))
