...
from NibiMusic import BOT_NAME
from NibiMusic.config import YOUTUBE_IMG_URL
...
async def play_thumb(videoid):
    ...
    try:
        ...
        font = ImageFont.truetype("NibiX/Font/font2.ttf", 40)
        font2 = ImageFont.truetype("NibiX/Font/font2.ttf", 70)
        arial = ImageFont.truetype("NibiX/Font/font2.ttf", 30)
        name_font = ImageFont.truetype("NibiX/Font/font.ttf", 30)
        para = textwrap.wrap(title, width=32)
        j = 0
        draw.text((5, 5), f"NIBI MUSIC", fill="white", font=name_font)
        draw.text(
            (600, 150),
            "NOW PLAYING",
            fill="white",
