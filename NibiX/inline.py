...
from NibiMusic.config import UPDATES_CHANNEL as TheBothub
...
def audio_markup(user_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="• ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/{TheBothub}"),
...
def menu_markup(user_id):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="🏡", url=f"https://t.me/{TheBothub}"),
